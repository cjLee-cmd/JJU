...
def define_prompts(answer_parser, question_parser):
  ...
  # 체인 생성 함수
def create_chains(answer_prompt, question_prompt, llm):
...
# Main 함수
def generate_response(query, db, answer_parser, question_parser):
  ...
  # Create Chains
  answer_chain, question_chain = create_chains(answer_prompt, question_prompt, llm)
